...
const queue = [
  ...
  // Campaign 5 (Prices change daily)
  {
    filename: "blog-why-fish-prices-change-daily-thane-mumbai-get-fair-rate-hero.png",
    aspectRatio: "16:9",
    prompt: "A professional, photorealistic 16:9 display of glistening fresh whole pomfrets and surmai fish, neatly arranged on a bed of clean, white crushed ice inside a spotless, modern display counter. Natural soft window light, professional and hygienic presentation, realistic scales and wet textures, shot on 50mm lens, f/2.8, no text.",
  },
  {
  ...
  // Campaign 6 (Real cost markup)
  {
    filename: "blog-real-cost-fish-mumbai-families-paying-more-than-should-thane-hero.png",
    aspectRatio: "16:9",
    prompt: "A professional, photorealistic 16:9 photograph of a clean, sanitised seafood packaging room. A worker in a spotless white uniform, hairnet, and gloves is carefully placing fresh surmai portions into premium Relifish cardboard boxes. Spotless stainless steel counters, bright natural lighting, f/2.8, 50mm lens, no text.",
  },
  {
  ...
  // Campaign 7 (Pre-order revolution)
  {
    filename: "blog-fresh-fish-thane-pre-order-revolution-hero.png",
    aspectRatio: "16:9",
    prompt: "A clean modular kitchen counter in a luxury Thane apartment. A clean stainless steel bowl holds raw, pre-cleaned, vacuum-sealed surmai steaks ready to cook. Beside it, a wooden cutting board with a knife and fresh lemon slices. Bright natural daylight, f/2.8, 50mm lens, no text.",
  },
  {
  ...
  // Campaign 8 (First order guide)
  {
    filename: "blog-first-relifish-order-guide-thane-hero.png",
    aspectRatio: "16:9",
    prompt: "A professional, photorealistic 16:9 photograph of unboxing a premium Relifish delivery on a marble kitchen table. An open, premium light brown cardboard box with black Relifish wordmark and fish logo printed on the side contains vacuum-sealed fresh pomfrets and prawns on ice gel packs. Pristine, odour-free presentation, shot on 50mm, f/2.8, natural daylight, no text.",
  },
  {
  ...
  // Campaign 10 (Neighbourhood pre-order / Doorstep delivery)
  {
    filename: "blog-neighbourhood-group-fish-preorder-thane-hero.png",
    aspectRatio: "16:9",
    prompt: "A professional, photorealistic 16:9 medium-wide shot of a doorstep delivery scene at a luxury Thane apartment corridor. A female delivery partner in a dark teal polo shirt with a small white 'relifish.store' logo on the sleeve, dark cargo pants, grey cap, grey face mask, and white gloves is handing an open, premium brown cardboard box with the black Relifish logo to a smiling Indian woman in a bright royal blue kurta. The box contains fresh pomfrets and prawns on ice. Peach walls, blue door, and neat potted plants in the background. Natural afternoon sunlight, shot on 50mm lens, f/2.8, background blur, no text.",
  },
  {
...
(async () => {
  console.log("🚀 Starting generation of clean & hygienic creative assets via Imagen 4 Ultra...");
  for (const item of queue) {
    await generateImage(item.prompt, item.filename, item.aspectRatio);
  }
  console.log("🎉 All assets regenerated successfully with premium hygiene focus!");
})();
