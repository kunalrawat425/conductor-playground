...
## The ORB Framework for Relifish
...
## Five-Phase Launch (per neighborhood)

### Phase 0: Pre-Launch Waitlist (current, months -3 to -1)
**Goal:** Build 50+ buyers + 5 sellers in Priority 1 neighborhoods before spending on ads.
...
- Standee print + placement incentives: ₹1K
- Creator seeding (catch boxes): ₹2K
- Instagram ads (awareness): ₹2K
- WhatsApp Business Premium + tools: ₹1K

### Phase 1: Soft Launch in Priority 1 Neighborhood (Month 1)
Trigger: Any neighborhood hits 50 buyer + 5 seller threshold.

Actions:
- Private WhatsApp group for first 50 buyers in that neighborhood
- "Founding 50" badge + 10% off first 3 orders (sellers fund half)
- Daily catch update at 7am in WhatsApp group
- First-order delight: handwritten thank-you note from seller
- In-person launch event at local market — 2 hours, free samples, signup table

### Phase 2: Amplify in Neighborhood (Month 2)
- Transition 50 buyers into reviewers — ask for Google/IG tags
- Creator posts go live (borrowed channels)
- Targeted Meta ads within 2 km radius of active sellers
- Referral program: "Refer a neighbor, both get ₹100 off" (see /referral-program)

### Phase 3: Expand to Priority 2 Neighborhood (Month 3)
- Replicate template using Phase 0→1→2 playbook
- Use Priority 1 social proof (testimonials, buyer count) as trust signals
...
- Open self-serve in all covered neighborhoods
- Delivery layer (not pickup-only) as a premium add-on
- Launch B2B: restaurants, caterers, dark kitchens

---

## 90-Day Launch Plan (with ₹12K/month)
...
| Spend | Amount | Channel |
|---|---|---|
| Meta ads (Priority 1 retargeting + Priority 2 awareness) | ₹6,000 | Rented |
| Referral program credits (₹100 × 20 successful referrals) | ₹2,000 | Owned |
| Flyer round 2 + standee refresh | ₹1,500 | Owned/physical |
...
## Launch-Day Tactics (per neighborhood)

**The 24-hour play:**
1. 7am: WhatsApp broadcast to area waitlist — "Today we're live in [neighborhood]. First order: 10% off."
2. 8am: Instagram story + feed post from 3 seeded creators
3. 9am: Paid Meta ad turns on, 2 km radius, "Live today" creative
4. 10am: Email to area waitlist with seller directory link
5. 12pm: Cardboard standee refresh at 5 key local stalls (bigger "WE'RE LIVE" sticker)
6. 5pm: Peak evening push — Instagram reel showing the day's fresh catch from your sellers
7. 8pm: WhatsApp broadcast — "Tomorrow's pre-orders close at 10pm. Order now."

**First 50 buyers get:** Founding Buyer badge, 10% off first 3 orders, priority area support.

---

## What NOT to Do

- **Don't launch city-wide.** Density beats reach for marketplaces.
- **Don't chase Product Hunt / Hacker News.** Wrong audience — these are global tech crowds, not Mumbai fish buyers.
- **Don't compete on "discount."** Lead with freshness + direct seller. Discounts only sweeten the first-order trial.
- **Don't take Swiggy/Zomato on directly.** Position as "no middleman" — don't name them in copy, just the behavior (markup, stale supply).
- **Don't over-invest in website SEO yet** — neighborhood launches first, then compounding content.
- **Don't neglect the seller side.** If buyers show up and catch is limited, the experience breaks. Maintain 3:1 buyer:seller ratio minimum.
...
|---|---|---|---|---|
| Waitlist signups | 200 | 500 | 1,000 | 3,000 |
| Neighborhoods launched | 1 | 2 | 3 | 6 |
| Active sellers | 5 | 10 | 18 | 40 |
| Orders/month | 20 | 100 | 300 | 1,500 |
| Repeat buyer rate | — | 30% | 40% | 55% |
| CAC (blended) | ≤₹300 | ≤₹200 | ≤₹150 | ≤₹100 |

---

## Related Next Steps
- `/referral-program` — design the "refer a neighbor" mechanic for Phase 2
- `/email-sequence` — build the post-waitlist nurture (3–5 emails before area launch)
- `/paid-ads` — detailed Meta + Google playbook (see next file)
- `/social-content` — Instagram content calendar
- `/ad-creative` — launch-ready ad variants
