...
**Market:** Mumbai's Hyperlocal Fresh Fish Marketplace — all Mumbai, verified hyperlocal sellers city-wide (strong density in Thane: Hiranandani Estate, Lodha, Majiwada, Kalwa, Ghodbunder Road, Kasarvadavali, Puranik, Rustomjee)
...
- **Commission model:** Zero commission currently (early growth). Future model: platform fee on transactions. Volume concentration in Mumbai apartments is the growth path.
...
*Corrected 2026-06-20: Mumbai marketplace positioning, Thane service areas, UPI payments implemented, commission currently 0% (early growth phase)*
